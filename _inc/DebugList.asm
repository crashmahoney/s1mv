...
DebugList:
	...
	dc.w @HUBZ-DebugList
	dc.w @IntroZ-DebugList
	dc.w @Tropic-DebugList
...
;	dbug	Map_Crab,	id_Crabmeat,		0,	0,	$400
	...
	dbug	Map_GBall,	id_PowerUp2,		0,	0,	$43AA
...
;		mappings	object		subtype	frame	VRAM setting
	...
	dbug	Map_Lamp,	id_Lamppost,	1,	0,	$7A0
	dbug	Map_Stair,	id_PushBlock,	0,	0,	$4000
	dbug	Map_Smab,	id_SmashBlock,	0,	0,	$4513
        @SLZend:
...
;		mappings	object		subtype	frame	VRAM setting
	...
	dbug	Map_Cat,	id_Caterkiller,	0,	0,	$24FF
	dbug	Map_Lamp,	id_Lamppost,	1,	0,	$7A0
	dbug	Map_FBlock,	id_PushBlock, 0,	0,	$4000
	dbug	Map_BossBlock,	id_SmashBlock, 0,	0,	$4000
        @SYZend:
...
;		mappings	object		subtype	frame	VRAM setting
	...
	dbug	Map_Lamp,	id_Lamppost,	1,	0,	$7A0
	dbug	Map_Push,	id_PushBlock,	0,	0,	$44BB
	dbug	Map_Smab,	id_SmashBlock,	0,	0,	$43F5
	dbug	Map_Smash,	id_SmashWall,	0,	3,	$43F5
        @SBZend:
