...
ptr_Pal_Race1	    palp    Pal_Race1,$FB20,$30			; $19 (25) - Race Bonus Stage
ptr_Pal_Race2	    palp    Pal_Race2,$FB20,$30			; $1A (26) - Race Bonus Stage2
...
palid_Race1:		equ (ptr_Pal_Race1-PalPointers)/8
palid_Race2:		equ (ptr_Pal_Race2-PalPointers)/8
