...
PCycle_Index:	dc.w PCycle_GHZ-PCycle_Index
		...
		dc.w PCycle_HUBZ-PCycle_Index
		dc.w PCycle_IntroZ-PCycle_Index
		dc.w PCycle_Tropic-PCycle_Index
...
; 
; 	PCycLZ_NotSBZ3:
		lea	(v_pal1_wat+$72).w,a1
		move.l	(a0,d0.w),(a1)+
		move.l	4(a0,d0.w),(a1)
		lea	(v_pal0_dry+$72).w,a1
		move.l	(a0,d0.w),(a1)+
		move.l	4(a0,d0.w),(a1)
...
PCycle_HUBZ:				; XREF: PalCycle
		rts	
; End of function PalCycle_HUBZ

; ||||||||||||||| S U B R O U T I N E |||||||||||||||||||||||||||||||||||||||

PCycle_IntroZ:				; XREF: PalCycle
		rts	
; End of function PalCycle_IntroZ

; ||||||||||||||| S U B R O U T I N E |||||||||||||||||||||||||||||||||||||||

PCycle_Tropic:				; XREF: PalCycle
		rts	
; End of function PalCycle_IntroZ
