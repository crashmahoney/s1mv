...
Deform_GHZ:				; XREF: Deform_Index
		...
		bsr.w	ScrollBlock3
                ...
                move.w	#$0000,($FFFFF70C).w	; lock the background vertically in place
...
; 		dbf	d1,loc_6384
		...
		move.w	#65-1,d1		; set number of scan lines to dump (minus 1 for dbf)
GHZ_DeformLoop_1:
		...
		move.w	#47-1,d1		; set number of scan lines to dump (minus 1 for dbf)
GHZ_DeformLoop_2:
		move.l	d0,(a1)+		; dump both the FG and BG scanline position to buffer
		...
		move.w	#41-1,d1		; set number of scan lines to dump (minus 1 for dbf)
GHZ_DeformLoop_3:
		move.l	d0,(a1)+		; dump both the FG and BG scanline position to buffer
		dbf	d1,GHZ_DeformLoop_3	; repeat d1 number of scanlines
		...
		neg.w	d0			; negate (positive to negative)
	;	No Speed Change
		move.w	#74-1,d1		; set number of scan lines to dump (minus 1 for dbf)
GHZ_DeformLoop_4:
		move.l	d0,(a1)+		; dump both the FG and BG scanline position to buffer
		dbf	d1,GHZ_DeformLoop_4	; repeat d1 number of scanlines
		rts
