...
@checknext:	
	...
	move.w	(a0),d1                  		; get object's y position and status info
	and.w	d5,d1	                 		; get y-position
	cmp.w	d3,d1                    		; compare to upper boundary to load object
	bcs.s	@nextobj						; branch, if object is out of range from the top
	cmp.w	d4,d1                    		; compare to lower boundary to load object
...
@notloaded:
		move.w	(a0)+,d7                 ; get object's x position
		move.w	(a0)+,d1                 ; get object's y position and status info
