...
ptr_SpinDash_dust:	dc.l SpinDash_dust
ptr_Turtroll:		dc.l Turtroll
ptr_WFZBoss:            dc.l WFZBoss
...
ptr_HomingTarget	dc.l HomingTarget	; $10
...
ptr_GunstarExplosion:	dc.l GunstarExplosion
...
ptr_InvincibilityStars:	dc.l InvincibilityStars		; $38
...
ptr_GotPowUpCard:	dc.l GotPowUpCard
...
ptr_MTZBoss:        dc.l MTZBoss
ptr_MTZBossOrbs:    dc.l MTZBossOrbs
ptr_HudText:	    dc.l HudText
ptr_TeleportBeam:	dc.l TeleportBeam     ; $90
ptr_Springboard		dc.l Springboard
ptr_SpeedBooster	dc.l SpeedBooster
ptr_Torch			dc.l Torch
...
id_InstaShield:		equ ((ptr_InstaShield-Obj_Index)/4)+1
id_SpinDashDust:	equ ((ptr_SpinDash_dust-Obj_Index)/4)+1
id_Turtroll:		equ ((ptr_Turtroll-Obj_Index)/4)+1
id_WFZBoss:             equ ((ptr_WFZBoss-Obj_Index)/4)+1               
...
id_HomingTarget:	equ ((ptr_HomingTarget-Obj_Index)/4)+1			; $10
...
id_PowerUp2:		equ ((ptr_PowerUp2-Obj_Index)/4)+1
...
id_GunstarExplosion:	equ ((ptr_GunstarExplosion-Obj_Index)/4)+1
...
id_InvincibilityStars:	equ ((ptr_InvincibilityStars-Obj_Index)/4)+1		; $38
...
id_GotPowUpCard:	equ ((ptr_GotPowUpCard-Obj_Index)/4)+1
...
id_MTZBoss:			equ ((ptr_MTZBoss-Obj_Index)/4)+1
id_MTZBossOrbs:		equ ((ptr_MTZBossOrbs-Obj_Index)/4)+1
id_HudText:			equ ((ptr_HudText-Obj_Index)/4)+1
id_TeleportBeam:	equ ((ptr_TeleportBeam-Obj_Index)/4)+1  ; $90
id_Springboard		equ ((ptr_Springboard-Obj_Index)/4)+1
id_SpeedBooster		equ ((ptr_SpeedBooster-Obj_Index)/4)+1
id_Torch			equ ((ptr_Torch-Obj_Index)/4)+1
