...
FindNearestTile:			; XREF: FindFloor; et al
		...
		moveq	#-1,d1					; MJ: prepare FFFF in d3 (as in $FFFFxxx memory location)
		movea.l	(v_lvllayout).w,a1			; MJ: load address of Layout to a1
...
; 		ror.w	#2,d1					; MJ: ..plus an extra 2 (so it's 80, not 200)
	...
	move.w	word_1E5D0(pc,d1.w),d1
		...
		andi.w	#$0E,d0					; MJ: keep X within 10 pixels
		add.w	d0,d1					; MJ: add to ror'd chunk ID
...
@blanktile:
		...
		rts						; MJ: return
; ===========================================================================
; precalculated values for FindNearestTile
