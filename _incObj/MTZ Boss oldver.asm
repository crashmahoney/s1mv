...
MTZ_Boss_2nd_Rout_0:
	...
	cmpi.w	#$4A0,(Boss_Y_pos).w            ; is boss lowered into starting position?
	blo.s	loc_32426
...
loc_32592:
	bsr.w	Boss_MoveObject
	cmpi.w	#$420,(Boss_Y_pos).w                ; reached top of screen?
	bhs.s	loc_325A4
...
; ===========================================================================
off_3264A:
		dc.w loc_32650-off_3264A	; 0
		dc.w loc_326B8-off_3264A	; 2
		dc.w loc_32704-off_3264A	; 4
; ===========================================================================
...
@chkleftedge:
	cmpi.w	#$2AF0,obX(a0)               ; at left edge of screen?
	bhs.s	@chkrightedge
	move.w	#$80,d1                      ; move right

@chkrightedge:
	cmpi.w	#$2BB0,obX(a0)               ; at right edge of screen?
	blo.s	@facedirection
