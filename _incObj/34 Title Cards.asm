...
; ---------------------------------------------------------------------------
Card_ConData:	dc.w $0020,$0120, $FEFC,$013C, $0414,$0154, $0214,$0154 ; GHZ
		dc.w $0000,$0120, $FEFC,$013C, $0414,$0154, $0214,$0154 ; LZ
		dc.w $0000,$0120, $FEFC,$013C, $0414,$0154, $0214,$0154 ; MZ
		dc.w $0000,$0120, $FEFC,$013C, $0414,$0154, $0214,$0154 ; SLZ
		dc.w $0000,$0120, $FEFC,$013C, $0414,$0154, $0214,$0154 ; SYZ
		dc.w $0000,$0120, $FEFC,$013C, $0414,$0154, $0214,$0154 ; SBZ
		dc.w $0000,$0120, $FEE4,$0144, $03EC,$03EC, $0214,$0154 ; FZ
         	dc.w $0000,$0120, $FEFC,$013C, $0414,$0154, $0214,$0154 ; end
		dc.w 0,	$120, $FF04, $144, $41C, $15C, $21C, $15C ; HUBZ
		dc.w 0,	$120, $FF04, $144, $41C, $15C, $21C, $15C ; IntroZ
		dc.w 0,	$120, $FF04, $144, $41C, $15C, $21C, $15C ; Tropic
