...
Spik_Main:	; Routine 0
		...
		move.w	#VRAMloc_Spikes/$20,obGfx(a0)
		ori.b	#4,obRender(a0)
...
Spik_Upright:				; XREF: Spik_Solid
		...
		move.w	obX(a0),d4
		bsr.w	SolidObject
		cmpi.b 	#sSpike,(v_equippedshoes).w ; +++ is Sonic wearing armoured boots?
		beq.s	Spik_Display	; +++ if yes, branch
		btst	#3,obStatus(a0)
		bne.s	Spik_Hurt
		tst.w	d4
		bpl.s	Spik_Display
...
Spik_Hurt:				; XREF: Spik_SideWays; Spik_Upright
		...
		tst.w 	(v_player+$30).w ; +++ is Sonic invulnerable? (fix spike bug)
		bne.s	Spik_Display	; +++ if yes, branch
		move.l	a0,-(sp)
		movea.l	a0,a2
		lea	(v_player).w,a0
...
Spik_Display:
		bsr.w	DisplaySprite
		obRange	@DeleteSpike,spik_origX(a0)
		rts
